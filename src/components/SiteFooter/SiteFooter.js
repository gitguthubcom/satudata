            ...
            <Row>
              ...
              <Col xl={2} lg={6} md={6} className="animated fadeInUp">
                <div className="footer-widget__column footer-widget__company clearfix">
                  <h3 className="footer-widget__title">Satu Data Perpusnas</h3>
              ...
              <Col xl={2} lg={6} md={6} className="animated fadeInUp">
                <div className="footer-widget__column footer-widget__explore">
                  <h3 className="footer-widget__title">Layanan Unggulan</h3>
            ...
            <Col xs={12}>
              <div className="site-footer__bottom-inner">
                ...
                <div className="site-footer__bottom-right">
                  <p>
                    © {year}, <a href="https://perpusnas.go.id/">{author}</a>
                  </p>
                </div>
